...
export function Hero({ variant, totalSignatures, onSuccess }: HeroProps) {
  ...
  return (
    <section className="relative min-h-[100svh] bg-hero-gradient overflow-x-clip">
      ...
      <div className="absolute inset-0 opacity-10 hidden sm:block pointer-events-none overflow-x-clip">
      ...
      <div className="absolute inset-y-0 left-0 right-0 opacity-5 hidden sm:block pointer-events-none overflow-x-clip">
      ...
      <div className="container max-w-full relative z-10 mx-auto px-4 pt-12 sm:pt-16 pb-24 sm:pb-12">
